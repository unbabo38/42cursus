...
AForm::AForm(std::string const &name, bool sign, int gradeToSign, int gradeToExecute)
    : _name(name), _sign(sign), _gradeToSign(gradeToSign), _gradeToExecute(gradeToExecute) {
    this->_checkGrades();
}
